...
import { HospitalEmail, HospitalLogin } from "../../Database/AdminService";
...
export default function AdminLogin() {
  ...
  const login = async (e) => {
    e.preventDefault();
    try {
      const Login = await HospitalLogin ({loginEmail,loginPassword});
      const res = await HospitalEmail(loginEmail);
      if(Login){
